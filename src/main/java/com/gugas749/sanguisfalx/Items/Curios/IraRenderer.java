...
@OnlyIn(Dist.CLIENT)
public class IraRenderer implements ICurioRenderer {
    private final IraItemRenderer curioRenderer = new IraItemRenderer();
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(
        ...
        ResourceLocation textureLocation = IraItemRenderer.TEX;
