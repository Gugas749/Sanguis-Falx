...
public class SFAzArmorLeggingTorsoLayerPipeline extends AzArmorRendererPipelineContext {
    public SFAzArmorLeggingTorsoLayerPipeline(AzRendererPipeline<UUID, ItemStack> rendererPipeline) {
